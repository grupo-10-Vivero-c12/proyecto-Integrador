window.addEventListener('load', ()=>{
    ...
    const expresiones = {
        ...
        // });
        inputs[1].addEventListener('keyup', validarFormulario(expresiones.nombre, inputs[1],campos.nombre));//() => {console.log('tecla levantada')}
        inputs[1].addEventListener('blur', validarFormulario());//() => {conseole.log('se ejecuto')}
